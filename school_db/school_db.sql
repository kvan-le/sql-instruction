...
-- zip code is used as var because if an integer starts at 03425 sql will only read it as 3425 and omit the 0
...
create table enrolled (
    ...
    -- constraint means student can't take the course twice
